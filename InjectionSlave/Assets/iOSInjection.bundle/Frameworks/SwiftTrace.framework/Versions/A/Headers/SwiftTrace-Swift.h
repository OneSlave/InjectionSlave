...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL preserveStatics;)
+ (BOOL)preserveStatics SWIFT_WARN_UNUSED_RESULT;
+ (void)setPreserveStatics:(BOOL)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) BOOL deviceInjection;)
+ (BOOL)deviceInjection SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSArray<NSString *> * _Nonnull traceableFunctionSuffixes;)
+ (NSArray<NSString *> * _Nonnull)traceableFunctionSuffixes SWIFT_WARN_UNUSED_RESULT;
+ (void)setTraceableFunctionSuffixes:(NSArray<NSString *> * _Nonnull)value;
...
/// \param replacee original function
///
///
/// returns:
/// pointer to end of chain of any interposes that have been aplied
